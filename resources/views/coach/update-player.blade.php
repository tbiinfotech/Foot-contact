...
<div class="col sec_cont">
   <div class="row">
      ...
      <div class="sp_rd add_coach">
         <form method="POST" enctype="multipart/form-data" action="{{ route('assign-coach-to-player',['id' => $id]) }}">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <label class="sd">
                     <select class="coach-list"> 
                        ...
                        @if(request()->get('id')==$coach->id)
                        <option id="{{$coach->id}}" value={{ $coach->id }} selected>{{ $coach->first_name }} {{ $coach->last_name }}</option>
                        @else
